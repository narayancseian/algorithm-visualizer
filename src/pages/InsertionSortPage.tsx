...
const InsertionSortPage = () => {
  ...
  const generateNewArray = useCallback(() => {
    ...
    setArray(newArray);
    const steps = insertionSort(newArray);
    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="lg:col-span-2">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">
              ...
              However, insertion sort provides several advantages: it is simple to implement, efficient for small data sets,
        ...
        <div>
          <Card>
            <CardContent className="pt-6">
              ...
              <h3 className="text-lg font-semibold mt-6 mb-2">How Insertion Sort Works</h3>
      ...
      {showComplexityModal && (
        <ComplexityModal
          ...
          spaceComplexity="O(1)"
          timeComplexityExplanation="Insertion Sort has a best-case time complexity of O(n) when the array is already sorted, as it only needs to make one comparison per element. In the average and worst cases, it has a time complexity of O(n²) as it may need to shift elements to make space for the current element."
          spaceComplexityExplanation="Insertion Sort has a space complexity of O(1) as it only requires a constant amount of extra space for temporary variables used in shifting elements."
        />
      )}
    </div>
  );
